...
def is_valid_word(word, hand, word_list):
    ...
    if word == "":
        ...
        if word in word_list:
            for char in word:
                if char in hand_temp and hand_temp.get(char) != 0:
                    count += 1
                    hand_temp[char] = hand_temp.get(char) - 1
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculate_hand_len(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if not is_valid_word(input_word, hand, word_list):
            ...
            # Otherwise (the word is valid):
                ...
                score += get_word_score(input_word, n)
                print(input_word + ' earned ' + str(get_word_score(input_word, n)) + ' points. Total: '
                      + str(score) + ' points.')
                # Update the hand
...
def play_game(word_list):
    ...
    while player_option != 'e':
        ...
        if player_option == 'n':
            ...
            play_hand(player_hand.copy(), word_list, HAND_SIZE)
            print()
